...
Please report any bugs  or  feature requests to C<bug-cpan-search-tester at rt.cpan.org>,  or
through the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=CPAN-Search-Tester>.
...
no Moose; # Keywords are removed from the CPAN::Search::Tester package
